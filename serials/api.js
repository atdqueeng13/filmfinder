...
const TMDB = (() => {
    ...
    const COUNTRY_CODES = {
        ...
        'Португалия': 'PT', 'Украина': 'UA', 'Беларусь': 'BY', 'Казахстан': 'KZ',
        'Израиль': 'IL', 'Индия': 'IN', 'Бразилия': 'BR', 'Мексика': 'MX',
        'Аргентина': 'AR', 'Колумбия': 'CO', 'Чили': 'CL', 'Перу': 'PE',
        'Тайвань': 'TW', 'Таиланд': 'TH', 'Сингапур': 'SG', 'Филиппины': 'PH',
        'Индонезия': 'ID', 'Малайзия': 'MY', 'Вьетнам': 'VN', 'Гонконг': 'HK',
        'ЮАР': 'ZA', 'Египет': 'EG', 'Новая Зеландия': 'NZ', 'Иран': 'IR',
        'Эстония': 'EE', 'Латвия': 'LV', 'Литва': 'LT', 'Грузия': 'GE',
        'Армения': 'AM', 'Азербайджан': 'AZ', 'Узбекистан': 'UZ', 'ОАЭ': 'AE',
        'Саудовская Аравия': 'SA', 'Марокко': 'MA', 'Нигерия': 'NG', 'Кения': 'KE'
    };
